...
http_status_questions = [
    ...
    'What is a real life metaphor of "HTTP statuses"?',  # Several HTTP Statuses, such as 301, 307, 308, and 402, have fairly direct parallels in the United States Postal Service
    ]
