...
pop_culture_questions = [
    'In "Ralph Breaks the Internet", what language was on Arthur\'s Heads Up Display (HUD)?\n@wreckitralph #RalphBreaksTheInternet',  # https://www.reddit.com/r/Python/comments/ariypt/just_noticed_that_the_code_in_ralph_breaks_the/
    'In "Stranger Things" Season 2, what language was used?\n@Stranger_Things @stnetflixtv',  # BASIC https://moviecode.tumblr.com/post/166870949505/at-least-they-tried-basic-from-stranger-things
